...
<html lang="en"  data-bs-theme="dark">
  ...
  <body>
    ...
    @include('js.main')
    @include('js.pages.project')
    @include('js.pages.home')
    @include('js.pages.loginAndRegister')
